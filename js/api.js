...
function apiGetOPD(provinsi) {
  return apiGet('getOPD', { provinsi: provinsi });
}

function apiGetRekap(provinsi) {
  return apiGet('getRekap', provinsi ? { provinsi: provinsi } : {});
}

function apiGetIsian(instrumen, kodeReferensi) {
  return apiGet('getIsian', { instrumen: instrumen, kodeReferensi: kodeReferensi });
}

function apiGetIsianRTL(provinsi, namaOPD) {
  return apiGet('getIsianRTL', { provinsi: provinsi, namaOPD: namaOPD });
}
...
function apiUpdateB1(idIsian, identity, jawaban) {
  return apiPost('updateB1', { idIsian: idIsian, identity: identity, jawaban: jawaban });
}

function apiUpdateB2(idIsian, identity, jawaban) {
  return apiPost('updateB2', { idIsian: idIsian, identity: identity, jawaban: jawaban });
}
...
function apiUpdateRTL(identity, kegiatan) {
  return apiPost('updateRTL', { identity: identity, kegiatan: kegiatan });
}
