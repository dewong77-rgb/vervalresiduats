...
- **Observasi (B1/B2)**: tiap instrumen adalah submission independen, identitas responden (nama, jabatan bebas teks, jumlah siswa, petugas pewawancara) + jawaban dikirim sekali per instrumen lewat `submitB1`/`submitB2`. Satu sekolah bisa punya B1 dan B2 dengan responden berbeda, dikirim terpisah.
